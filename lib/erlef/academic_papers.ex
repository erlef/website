defmodule Erlef.AcademicPapers do
  ...
  @spec create_academic_paper(map()) :: {:ok , AcademicPaper.t()} | {:error , Ecto.Changeset.t()}
  ...
  @spec update_academic_paper(AcademicPaper.t() , map()) :: {:ok , AcademicPaper.t()} | {:error , Ecto.Changeset.t()}
  ...
  @spec delete_academic_paper(AcademicPaper.t()) :: {:ok , AcademicPaper.t()}
  ...
  @spec change_academic_paper(AcademicPaper.t() , map()) :: Ecto.Changeset.t()  
  def change_academic_paper(%AcademicPaper{} = academic_paper , attrs \\ %{}), do: AcademicPaper.changeset(academic_paper , attrs)

  @spec unapproved_all() :: [AcademicPaper.t()]
  def unapproved_all(), do: Query.unpublished()

  @spec approve_academic_paper(AcademicPaper.t() , map()) :: {:ok , AcademicPaper.t()} | {:error , Ecto.Changeset.t()}
  ...
  defp normalize_params(params) do
    params0 = case Map.fetch(params , "technologies") do
      		{:ok , _val} ->
	 	   params
      		:error ->
  ...
  defp maybe_add_date_error(changeset , true), do: Changeset.add_error(changeset , :original_publish_date , "Invalid Date")
